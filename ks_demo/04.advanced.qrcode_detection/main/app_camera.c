/**
 * @file app_camera.c
 * @brief Camera Driver Init and Capture
 *
 * ESP32-S3 camera driver config (pins, format, resolution).
 *
...
static camera_config_t camera_config = {
   ...
   .fb_location = CAMERA_FB_IN_PSRAM,//存放在外部PSRAM中
    ...
    .fb_count = 1,                    // RGB565 mode is more stable with a single frame buffer
