...
#if !defined(CONFIG_CAMERA_MODULE_WROVER_KIT) && \
    !defined(CONFIG_CAMERA_MODULE_ESP_EYE) && \
    !defined(CONFIG_CAMERA_MODULE_ESP_S2_KALUGA) && \
    !defined(CONFIG_CAMERA_MODULE_ESP_S3_EYE) && \
    !defined(CONFIG_CAMERA_MODULE_ESP32_CAM_BOARD) && \
    !defined(CONFIG_CAMERA_MODULE_M5STACK_PSRAM) && \
    !defined(CONFIG_CAMERA_MODULE_M5STACK_WIDE) && \
    !defined(CONFIG_CAMERA_MODULE_AI_THINKER) && \
    !defined(CONFIG_CAMERA_MODULE_CUSTOM)
