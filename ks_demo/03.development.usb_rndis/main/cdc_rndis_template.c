...
void cdc_rndis_init(uint8_t busid, uint32_t reg_base)
{
    ...
    usbd_add_interface( busid, usbd_rndis_init_intf(&intf0, CDC_OUT_EP, CDC_IN_EP, CDC_INT_EP, tud_network_mac_address));
    usbd_add_interface( busid, usbd_rndis_init_intf(&intf1, CDC_OUT_EP, CDC_IN_EP, CDC_INT_EP, tud_network_mac_address));
