...
esp_err_t spi_init(void)
{
    spi_bus_config_t buscfg = {
        .sclk_io_num     = SPI_CLK_GPIO_PIN,    /* 时钟引脚 */
        .mosi_io_num     = SPI_MOSI_GPIO_PIN,    /* 主机输出从机输入引脚 */
        .miso_io_num     = SPI_MISO_GPIO_PIN,    /* 主机输入从机输出引脚 */
    ...
    /* 添加SPI总线设备 */
    ESP_ERROR_CHECK(spi_bus_add_device(SPI_HOST, &devcfg, &SD_Handle));
