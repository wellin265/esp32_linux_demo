/**
 * @file app_main.c
 * @brief BluFi app_main
 *
 * BluFi provisioning app_main module.
 *
...
void app_main(void)
{
    ...
    if (ksdiy_lvgl_lock(0))
    {
        ...
        lv_label_set_text(label, "This is a demo for bluetooth config wifi connection to ap. \nYou can config ESP32 to connect a softap or \nconfig ESP32 as a softap to be connected by other device.");
