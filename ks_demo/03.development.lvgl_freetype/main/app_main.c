...
#define FONT_PATH "/spiffs/Ding.ttf"
...
bool create_example_freetype(void)
{
   ...
   lv_obj_align(label_reference, LV_ALIGN_CENTER, 0, 0);

   lv_label_set_text(label_map_info, "Map:info30 中文显示测试");
   lv_label_set_text(label_info, "Font:info20 中文显示测试");
   lv_label_set_text(label_reference, "Font:info25 \n中文显示测试\n  酷世DIY");
