...
static lv_anim_t * lv_lottie_start_anim(lv_obj_t * obj, int32_t end_value, int32_t time_ms);
...
void lv_lottie_set_src_data(lv_obj_t * obj, const void * src, size_t src_size)
{
    ...
    lottie->anim = lv_lottie_start_anim(obj, (int32_t)f_total, (int32_t)f_total * 1000 / 60); /*60 FPS*/
...
static void lv_lottie_destructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    lv_anim_del(obj, (lv_anim_exec_xcb_t)anim_exec_cb);
    lottie->anim = NULL;
    tvg_animation_del(lottie->tvg_anim);
...
static lv_anim_t * lv_lottie_start_anim(lv_obj_t * obj, int32_t end_value, int32_t time_ms)
{
    ...
    lv_anim_set_values(&a, 0, end_value);
